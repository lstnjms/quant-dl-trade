# -*- coding: utf-8 -*-
"""
批量全量下载：A股每日资金流向（TuShare moneyflow）
- 支持全市场或指定指数成分股
"""
...
FIELDS = (
    ...
    "buy_elg_vol,buy_elg_amount,sell_elg_vol,sell_elg_amount,net_mf_amount"
)
...
def _normalize(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.rename(columns={
        ...
        "buy_sm_vol":"buy_sm_vol_t","buy_sm_amount":"buy_sm_amount_t",
        "sell_sm_vol":"sell_sm_vol_t","sell_sm_amount":"sell_sm_amount_t",
        "buy_md_vol":"buy_md_vol_t","buy_md_amount":"buy_md_amount_t",
        "sell_md_vol":"sell_md_vol_t","sell_md_amount":"sell_md_amount_t",
        "buy_lg_vol":"buy_lg_vol_t","buy_lg_amount":"buy_lg_amount_t",
        "sell_lg_vol":"sell_lg_vol_t","sell_lg_amount":"sell_lg_amount_t",
        "buy_elg_vol":"buy_elg_vol_t","buy_elg_amount":"buy_elg_amount_t",
        "sell_elg_vol":"sell_elg_vol_t","sell_elg_amount":"sell_elg_amount_t",
...
def main(start: str, end: str, sleep_s: float, index_code: str):
    ...
    for i, code in enumerate(codes, 1):
        try:
            df = pro.moneyflow(ts_code=code, start_date=start, end_date=end, fields=FIELDS)
